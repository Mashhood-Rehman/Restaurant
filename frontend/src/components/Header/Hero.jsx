...
//           <h1 className="lg:text-4xl text-xl md:text-5xl font-bold">Enjoy Our Delicious Meal</h1>
...
const Hero = () => {
  ...
  return (
    <div>
       <img src={carouselImages[currentPic]} alt="hero-pic" width={400} height={500} className='w-full h-auto ' />
    </div>
  )
}
