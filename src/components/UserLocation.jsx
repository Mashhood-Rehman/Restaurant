    ...
    <div className="flex items-center justify-center z bg-gray-100">
      ...
      >
        {showLocationButton && !hover && (
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 mt-44 -ml-6 lg:mt-1 px-4 rounded">
            Show Live Location
          </button>
        )}
        {hover && showLocationDetails && (
          <div className="w-96 bg-green-500 rounded -ml-3 mt-44 md:mt-1">
            ...
            <p className="text-white">Location Name: {locationName}</p>
          </div>
        )}
      </div>
    </div>
