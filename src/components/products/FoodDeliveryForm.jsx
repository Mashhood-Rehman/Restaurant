        ...
        <div class="flex flex-wrap -mx-3 mb-2">
          ...
          <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <div>
              ...
              <button onClick={() =>setVisible(false)} className=" bg-red-500  object-contain rounded-full "><Icon className="h-6 w-6" icon="simple-line-icons:close" /></button>
    </div>
    </Modal>
